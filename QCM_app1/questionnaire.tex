...
JMA2%
 \begin{flushright}  \vskip-7mm05/07/2022 \end{flushright}%
...
\item%
Chaque réponse exacte est gratifiée de 3 points, tandis que chaque réponse fausse est pénalisée par 0 point. \\ 	Parmi les quatre propositions de chacune des questions \textbf{de 1 à 2}, une seule est vraie, les autres sont fausses. ( 3points par question) \\ 	Par exemple : Pour indiquer que l'affirmation $B$ est Vraie, cocher les cases comme suit:  \\ \begin{center}	\includegraphics[scale=0.8]{reponses.png} \end{center}%
\begin{exercise}%
\textbf{GF }%
