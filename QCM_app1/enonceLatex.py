...
def genererEnonce(informations, Questions):
    """
    Generate the enonces for the questions.
    @param informations - the informations dictionary
    @param Questions - the questions dictionary
    @return The enonces dictionary
    """
    print("hatim")
    ...
    doc.generate_pdf('QCM_app1/Enonce', clean_tex=False, compiler='pdfLaTeX')
